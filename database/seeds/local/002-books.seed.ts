 ...
 * Seed Books
 *
 * Creates initial book catalog with sample data.
 */

export default async function seedBooks(db: any) {
  const books = [
    {
      id: '001',
      slug: 'bbq',
    ...
    {
      id: '004',
      slug: 'cooking-with-fire',
      title: 'Cooking with Fire',
      author: 'Chef Blaze',
      description: 'Master the art of open-flame cooking.',
      price: 24.99,
      genre: 'cookbook',
    ...
    {
      id: '005',
      slug: 'jazz-essentials',
      title: 'Jazz Essentials',
      author: 'Miles Chord',
      description: 'Everything you need to know about jazz music.',
      price: 32.0,
      genre: 'music',
      imageUrls: ['/images/placeholder.png'],
      coverUrl: '/images/placeholder.png',
    ...
    },
    {
      ...
      author: 'Zen Master Wu',
      description: 'Find peace and balance in your daily life.',
      price: 19.99,
      genre: 'self-help',
      imageUrls: ['/images/placeholder.png'],
      coverUrl: '/images/placeholder.png',
  ...
  console.log(`   ✓ Seeded ${batch.length} records`)
}
